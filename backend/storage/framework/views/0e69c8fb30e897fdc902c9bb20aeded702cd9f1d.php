    ...
    <script>
        ...
        function BrandAdd(name, categories, image) {
            if (name.length == 0) {
                ...
                // brand.store
                axios.post("<?php echo e(route('brand.store')); ?>", formData, {
                    headers: {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel-project\ecom-final\backend\resources\views/admin/components/Brands.blade.php ENDPATH**/ ?>
