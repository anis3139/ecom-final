                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <img id="updateCategoryIconPreview" style="height: 100px !important;"
                                    class="imgPreview mt-3 " src="<?php echo e(asset('admin/images/default-image.png')); ?>" />
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function CategoryDropDownPush() {
            // Add Category List
            axios.get("<?php echo e(route('admin.getCategoriesParantData')); ?>")
                .then(function(response) {
        ...
        function CategoryAdd(name, categories, icon, image, catStatus) {
            if (name.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.addCategory')); ?>", fm, {
                    headers: {
        ...
        function DeleteDataCategory(id) {
            $('#confirmDeleteCategory').html(
                "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
            axios.post("<?php echo e(route('admin.deleteCategory')); ?>", {
                    id: id
                })
                .then(function(response) {
 ...
 $(document).ready(function() {
        ...
        function CategoryUpdateDetails(id) {
            axios.post("<?php echo e(route('admin.getEditCategoryData')); ?>", {
                    id: id
                })
                .then(function(response) {
        ...
        function CategoryUpdate(idUpdate, nameUpdate, CategoriesEdit, img, icon, catEditStatus) {
            if (nameUpdate.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.updateCategory')); ?>", formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                }).then(function(response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel-project\ecom-final\backend\resources\views/admin/components/Categories.blade.php ENDPATH**/ ?>
