...
<?php $__env->startSection('title', 'Home About Setting'); ?>

<?php $__env->startSection('content'); ?>


<?php echo $__env->make('admin.components.aboutSection', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.components.specialFeature', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.components.exclusiveFeature', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.components.testimonial', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function addTitle(title) {
            if (title.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.addHAtitle')); ?>", {
                        title: title
                    })
        ...
        function addDescription(description) {
            if (description.length == 0) {
                ...
                $('#submitDescription').html(
                    "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
                axios.post("<?php echo e(route('admin.addHADescription')); ?>", {
        ...
        function addAboutImage(image) {
            ...
            axios.post("<?php echo e(route('admin.addHAimage')); ?>", formData, {
                headers: {
        ...
        function addAboutImage2(image2) {
            ...
            axios.post("<?php echo e(route('admin.addHAimage2')); ?>", formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            }).then(function(response) {
        ...
        function addAboutImage3(image3) {
            ...
            axios.post("<?php echo e(route('admin.addHAimage3')); ?>", formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            }).then(function(response) {
        ...
        function getHomeFeaturedSpecialsData() {
            ...
            axios.get("<?php echo e(route('admin.getFSdata')); ?>")
                .then(function(response) {
        ...
        function FeaturedSpecialsAdd(title, description) {
            ...
            if (title.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.addFSdata')); ?>", {
                        title: title,
                        description: description,
                    })
        ...
        function DeleteDataSlider(id) {
            ...
            axios.post("<?php echo e(route('admin.homeFSdelete')); ?>", {
                    id: id
                })
                .then(function(response) {
        ...
        function FeaturedSpecialsUpdateDetails(id) {
            ...
            axios.post("<?php echo e(route('admin.HomeFSEdit')); ?>", {
                    id: id
                })
                .then(function(response) {
        ...
        function SliderUpdate(idUpdate, nameUpdate, desUpdate) {
            ...
            if (nameUpdate.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.HomeFSUpdate')); ?>", {
                        id: idUpdate,
                        title: nameUpdate,
                        description: desUpdate,
                    })
...
axios.post("<?php echo e(route('admin.addEXPimage')); ?>", formData, {
    headers: {
        'Content-Type': 'multipart/form-data'
    }
}).then(function(response) {
    ...
    toastr.error('Something Went Wrong');
        ...
        function getHomeExclusiveSpecialsData() {
            ...
            axios.get("<?php echo e(route('admin.getEXPdata')); ?>")
                .then(function(response) {
        ...
        function ExclusiveFeatureAdd(exp_title, exp_description) {
            ...
            if (exp_title.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.homeEXPAdd')); ?>", {
                    exp_title: exp_title,
        ...
        function DeleteDataEXP(id) {
            ...
            axios.post("<?php echo e(route('admin.HomeEXFDelete')); ?>", {
                    id: id
                })
                .then(function(response) {
...
axios.post("<?php echo e(route('admin.HomeEXPEdit')); ?>", {
        id: id
    })
    .then(function(response) {
...
if (exp_title.length == 0) {
    ...
    axios.post("<?php echo e(route('admin.HomeEXPUpdate')); ?>", {
            id: EXPidUpdate,
            exp_title: exp_title,
            exp_description: exp_description,
        })
...
// Testimonial Section
        ...
        function getHomeTestimonialData() {
            ...
            axios.get("<?php echo e(route('admin.getTestimonialData')); ?>")
                .then(function(response) {
        ...
        function sliderAdd(TestimonioalName, TestimonioalDate, TestimonioalDes, Testimonioalimg) {
            ...
            if (TestimonioalName.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.TestimonialAdd')); ?>", formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                }).then(function(response) {
...
//  Testimonial delete modal yes button
        ...
        function DeleteDataTestimonioal(id) {
            ...
            axios.post("<?php echo e(route('admin.TestimonialDelete')); ?>", {
                    id: id
                })
                .then(function(response) {
...
axios.post("<?php echo e(route('admin.getTestimonialEditData')); ?>", {
        id: id
    })
    .then(function(response) {
...
if (nameUpdate.length == 0) {
    ...
    axios.post("<?php echo e(route('admin.TestimonilaUpdate')); ?>", formData, {
        headers: {
            'Content-Type': 'multipart/form-data'
        }
    }).then(function(response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel-project\ecom-final\backend\resources\views/admin/Homepage.blade.php ENDPATH**/ ?>