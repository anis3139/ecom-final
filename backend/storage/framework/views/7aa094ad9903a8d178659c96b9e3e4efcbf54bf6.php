...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function getOrdersdata() {
            axios.get("<?php echo e(route('admin.getOrdersData')); ?>")
        ...
        $('#product_status_form').submit(function(event) {
            ...
            let url =" <?php echo e(route('admin.ordersStatusUpdate')); ?>";
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel-project\ecom-final\backend\resources\views/admin/order/order.blade.php ENDPATH**/ ?>
