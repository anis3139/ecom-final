...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('admin.partials.productPartisal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function getProductsdata() {
            ...
            axios.get("<?php echo e(route('admin.getProductData')); ?>")
        ...
        // Add Category List
        axios.get("<?php echo e(route('admin.getCategoriesData')); ?>")
            .then(function(response) {
                var dataJSON = response.data;
                $('#pdCategory').empty();
        ...
        // Add Category List
        axios.get("<?php echo e(route('admin.getBrandsData')); ?>")
            .then(function(response) {
                var dataJSON = response.data;
        ...
        function productAdd(product_title, product_discription, product_price, product_selling_price, product_quantity,
            ...
            if (product_title.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.productAdd')); ?>", fm, {
                    headers: {
        ...
        function DeleteProductsData(id) {
            $('#confirmDeleteproduct').html(
                "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
            axios.post("<?php echo e(route('admin.delete')); ?>", {
                    id: id
                })
                .then(function(response) {
...
// Product Details View
        function ProductsViewDetails(id) {
            axios.post("<?php echo e(route('admin.getEditProductsData')); ?>", {
                    id: id
                })
                .then(function(response) {
                    if (response.status == 200) {
        ...
        function productUpadate(product_id_edit, pdEditName, pdEditDescription, pdEditPrice, pdEditOffer, pdEditQuantity, pdEditCategory, pdEditBrand, pdEditStock, pdEditFeature, pdEditStatus, editImagesValue, pdmesermentValueEdit, editedValueOfColor,slelctedmesermentEdit) {
            if (pdEditName.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.productsUpdate')); ?>", fm, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                }).then(function(response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel-project\ecom-final\backend\resources\views/admin/components/Products.blade.php ENDPATH**/ ?>