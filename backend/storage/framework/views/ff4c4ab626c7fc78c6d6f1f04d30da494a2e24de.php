...
<div class="row mt-5">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body  text-center">
                    ...
                    <img id="TestimonialLoader" class="loding-icon m-5 d-none" src="<?php echo e(asset('loader.svg')); ?>" alt="">
    ...
    <!-- Testimonial update -->
<?php /**PATH E:\laravel-project\ecom-final\backend\resources\views/admin/components/testimonial.blade.php ENDPATH**/ ?>