            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  <ul>
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="{{ asset('client/img')}}/woman-small-2.jpg" alt="img"></a>
                    ...
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="{{ asset('client/img')}}/woman-small-1.jpg" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                      </div>
