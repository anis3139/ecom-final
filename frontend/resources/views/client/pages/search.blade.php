...
@section('content')
    ...
    <section id="aa-product-category">
        <div class="container">
            ...
            @else
            <div  style="margin:30px 0px 10px 0px; text-align:center; background-color:#ebd4d4; padding:20px; ">
                <h2 style="color:#000">You Search for: <span style="color:#FF6666">{{$key}}</span></h2>
            </div>
