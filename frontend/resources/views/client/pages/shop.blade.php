           ...
           <aside class="aa-sidebar">
             ...
             <div class="aa-sidebar-widget">
               ...
               <div class="aa-recently-views">
                 <ul>
                   <li>
                     <a href="#" class="aa-cartbox-img"><img alt="img" src="{{ asset('client') }}/img/woman-small-2.jpg"></a>
                   ...
                   <li>
                     <a href="#" class="aa-cartbox-img"><img alt="img" src="{{ asset('client') }}/img/woman-small-1.jpg"></a>
                     <div class="aa-cartbox-info">
                       <h4><a href="#">Product Name</a></h4>
                       <p>1 x $250</p>
                     </div>
