                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                            ...
                            <div id="BlogEditForm" class="container d-none">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input readonly id="name" type="text" class="form-control mb-3"
                                            placeholder="Name">

                                        <textarea name="post" id="post" cols="30" rows="10" class="form-control mb-3"></textarea>
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="BlogupdateConfirmBtn" type="button"
...
function BlogUpdate(id,  post, status) {
    ...
    if (post.length == 0) {
        ...
        axios.post("{{ route('admin.blog.update') }}", updateData).then(function(response) {
