				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="mr-lg-4">
							<a href="demo-shop.html" class="standard-logo"><img src="{{asset('client')}}/demos/shop/images/logo.png" alt="Canvas Logo"></a>
							<a href="demo-shop.html" class="retina-logo"><img src="{{asset('client')}}/demos/shop/images/logo@2x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{asset('client')}}/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{asset('client')}}/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
											...
											<div class="row">
												...
												<ul class="sub-menu-container mega-menu-column col-lg-3 border-left-0">
													<li class="card p-0 bg-transparent border-0">
														<img class="card-img-top" src="{{asset('client')}}/demos/shop/images/menu-image.jpg" alt="image cap">
