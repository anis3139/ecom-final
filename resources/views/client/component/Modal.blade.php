    ...
    <div class="product modal-padding">
        ...
        <div class="row col-mb-50">
                        ...
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide"><a href="#" title="Pink Printed Dress - Front View"><img
                                            src="demos/shop/images/items/new/1.jpg" alt="Pink Printed Dress"></a></div>
                                <div class="slide"><a href="#" title="Pink Printed Dress - Side View"><img
                                            src="demos/shop/images/items/new/1-1.jpg" alt="Pink Printed Dress"></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 product-desc">
                <div class="product-price"><del>$39.99</del> <ins class="font-weight-semibold" id="pdPrice"></ins></div>
