 ...
 <div id="oc-products" class="owl-carousel products-carousel carousel-widget" data-margin="20" data-loop="true"
     ...
     <div class="oc-item">
         <div class="product">
             <div class="product-image">
                 <a href="#"><img src="{{ asset('client') }}/demos/shop/images/items/featured/1.jpg"
                         alt="Round Neck T-shirts"></a>
                 <a href="#"><img src="{{ asset('client') }}/demos/shop/images/items/featured/1-1.jpg"
                         alt="Round Neck T-shirts"></a>
                 ...
                 <div class="bg-overlay">
                     <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn"
                         ...
                         <a href="demos/shop/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i
             ...
             <div class="product-desc">
                 ...
                 <div class="product-price font-primary"><del class="mr-1">$24.99</del> <ins>$12.49</ins>
                 </div>
     ...
     <div class="oc-item">
         <div class="product">
             <div class="product-image">
                 <a href="#"><img src="{{ asset('client') }}/demos/shop/images/items/featured/2.jpg"
                         alt="Navy Blue Dress"></a>
                 <a href="#"><img src="{{ asset('client') }}/demos/shop/images/items/featured/2-1.jpg"
                         alt="Navy Blue Dress"></a>
                 <div class="bg-overlay">
                     <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn"
                         data-hover-speed="400">
     ...
     <div class="oc-item">
         <div class="product">
             <div class="product-image">
                 ...
                 <a href="#"><img src="{{ asset('client') }}/demos/shop/images/items/featured/5-1.jpg"
                         alt="Shoes"></a>
                 <div class="bg-overlay">
     ...
     <div class="oc-item">
         <div class="product">
                     ...
                     <div class="flexslider">
                         <div class="slider-wrap">
                             <div class="slide"><a href="#"><img
                                         src="{{ asset('client') }}/demos/shop/images/items/featured/4.jpg"
                                         alt="T-shirts"></a></div>
                             <div class="slide"><a href="#"><img
                                         src="{{ asset('client') }}/demos/shop/images/items/featured/4-1.jpg"
                                         alt="T-shirts"></a></div>
                             <div class="slide"><a href="#"><img
                                         src="{{ asset('client') }}/demos/shop/images/items/featured/4-2.jpg"
                                         alt="T-shirts"></a></div>
                             <div class="slide"><a href="#"><img
                                         src="{{ asset('client') }}/demos/shop/images/items/featured/4-3.jpg"
                                         alt="T-shirts"></a></div>
                         </div>
                     </div>
                 </div>
             ...
             <div class="product-desc">
                 ...
                 <div class="product-price font-primary"><del class="mr-1">$27.99</del> <ins>$21.00</ins>
                 </div>
                 <div class="product-rating">
                     <i class="icon-star3"></i>
                     <i class="icon-star3"></i>
     ...
     <div class="oc-item">
         <div class="product">
             <div class="product-image">
                 <a href="#"><img src="{{ asset('client') }}/demos/shop/images/items/featured/3.jpg"
                         alt="T-shirts"></a>
                 <div class="bg-overlay">
                     <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn"
                         data-hover-speed="400">
