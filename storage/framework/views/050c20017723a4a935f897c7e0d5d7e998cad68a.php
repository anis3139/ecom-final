        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ml-auto">
            <div class="login-card card">
                ...
                <div class="card-body pt-0">
                    ...
                    <form action="<?php echo e(route('client.upadeteProfile', $user->id)); ?>" method="POST"
                        ...
                        <div class="form-group my-4">
                            ...
                            <input type="text" class="form-control login" name="postal_code" id="postal_code"
                                placeholder="Zip Code" value="<?php echo e($user->postal_code); ?>">
                        </div>
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/client/pages/ProfileEdit.blade.php ENDPATH**/ ?>