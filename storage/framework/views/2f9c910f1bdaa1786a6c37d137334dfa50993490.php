            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body  text-center">
                        ...
                        <img id="PagesLoader" class="loding-icon m-5 d-none" src="<?php echo e(asset('loader.svg')); ?>" alt="">
...
getPagesdata();
        function getPagesdata() {
            axios.get("<?php echo e(route('admin.getpagesdata')); ?>")
        ...
        function PagesAdd(name, des) {
            if (name.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.addpages')); ?>", formData, {
                    headers: {
        ...
        function PagesUpdateDetails(id) {
            axios.post("<?php echo e(route('admin.pagesdetails')); ?>", {
                    id: id
                })
                .then(function(response) {
                    if (response.status == 200) {
        ...
        function PagesUpdate(idUpdate, nameUpdate, desUpdate) {
            if (nameUpdate.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.pagesupdate')); ?>", formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                }).then(function(response) {
        ...
        function DeleteDataPages(id) {
            $('#confirmDeletePages').html(
                "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
            axios.post("<?php echo e(route('admin.pagesdelete')); ?>", {
                    id: id
                })
                .then(function(response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/admin/components/pages.blade.php ENDPATH**/ ?>