                            ...
                            <div class="col-md-8 offset-md-2">
                                ...
                                <div class="aa-myaccount-register">
                                    ...
                                    <form id="login-form" name="login-form" class="row"
                                        action="<?php echo e(route('client.forgotPassword')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        <div class="col-12">
                                    ...
                                    <?php if(auth()->guard()->guest()): ?>
                                        <div class="col-md-12" style="margin-top: 20px !important">
                                            <p>Don't have an account? <a class="text-primary"
                                                    href="<?php echo e(route('client.registration')); ?>"> Register now! </a></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/client/pages/Forgot.blade.php ENDPATH**/ ?>