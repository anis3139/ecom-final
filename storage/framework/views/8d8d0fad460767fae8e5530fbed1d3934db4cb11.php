...
<script type="text/javascript">
    ...
    function getReviewdata() {
        ...
        axios.get("<?php echo e(route('admin.getReviewdata')); ?>")
    ...
    function DeleteDataReview(id) {
        ...
        axios.post("<?php echo e(route('admin.deleteReview')); ?>", {
                id: id
            })
            .then(function(response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/admin/components/reviewRating.blade.php ENDPATH**/ ?>