...
<?php $__env->startSection('content'); ?>
    ...
    <section id="page-title">
        ...
        <div class="container clearfix">
            <h1> All Product under <a href="<?php echo e(route('client.category', $category->slug)); ?>" class="text-primary">
                    <?php echo e($category->name); ?></a> Category</h1>
            <ol class="breadcrumb">
                                                ...
                                                <div class="bg-overlay-content align-items-end justify-content-between"
                                                    ...
                                                    <?php if(auth()->guard()->guest()): ?>
                                                        <a href="javascript:void(0);" onclick="toastr.info('To add Favorite List. You need to login first.','Info',{
                                                            ...
                                                            <span>
                                                                (<?php echo e($allProduct->favorite_to_users->count()); ?>)</span></a>
                                                    <?php else: ?>
                                                        <a href="javascript:void(0);"
                                                            onclick="document.getElementById('favorite-form-<?php echo e($allProduct->id); ?>').submit();"
                                                            class="<?php echo e(!Auth::user()->favorite_product->where('pivot.product_id', $allProduct->id)->count() == 0
    ? 'favorite_posts'
    : ''); ?>"><i
                                                                class="icon-heart3"></i><span class="text-dark">(<span
                                                                    class="favorite_posts"><?php echo e($allProduct->favorite_to_users->count()); ?></span>)</span></a>

                                                        <form id="favorite-form-<?php echo e($allProduct->id); ?>" method="POST"
                                                            action="<?php echo e(route('client.favorite', $allProduct->id)); ?>"
                                                            style="display: none;">
                                                            <?php echo csrf_field(); ?>
                                                        </form>
                                                    <?php endif; ?>
