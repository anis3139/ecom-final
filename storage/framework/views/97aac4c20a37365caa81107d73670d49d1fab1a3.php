...
if (facebook.length == 0) {
    ...
    axios.post("<?php echo e(route('admin.facebook')); ?>", {
        facebook: facebook
    })
...
if (twitter.length == 0) {
    ...
    $('#submitTwitter').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("<?php echo e(route('admin.twitter')); ?>", {
        twitter: twitter
    })
        .then(function (response) {
...
if (youtube.length == 0) {
    ...
    $('#submitYoutube').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("<?php echo e(route('admin.youtube')); ?>", {
        youtube: youtube
    })
        .then(function (response) {
...
if (instragram.length == 0) {
    ...
    $('#submitInstagram').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("<?php echo e(route('admin.instragram')); ?>", {
...
if (linkin.length == 0) {
    ...
    $('#submitLinkin').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("<?php echo e(route('admin.linkin')); ?>", {
        linkin: linkin
    })
        .then(function (response) {
...
if (google.length == 0) {
    ...
    $('#submitGoogle').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("<?php echo e(route('admin.google')); ?>", {
        google: google
    })
        .then(function (response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/admin/components/socialLink.blade.php ENDPATH**/ ?>