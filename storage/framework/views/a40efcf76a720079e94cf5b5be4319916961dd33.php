                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body  text-center">
                            ...
                            <img id="SliderLoader" class="loding-icon m-5 d-none" src="<?php echo e(asset('loader.svg')); ?>" alt="">
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        function getSliderdata() {
            axios.get("<?php echo e(route('admin.getsliderdata')); ?>")
        ...
        function SliderAdd(name, des, img) {
                ...
                axios.post("<?php echo e(route('admin.addslider')); ?>", formData, {
                    headers: {
        ...
        function SliderUpdateDetails(id) {
            axios.post("<?php echo e(route('admin.sliderdetails')); ?>", {
                    id: id
                })
                .then(function(response) {
                    if (response.status == 200) {
        ...
        function SliderUpdate(idUpdate, nameUpdate, desUpdate, imgUpdate) {
                ...
                axios.post("<?php echo e(route('admin.sliderupdate')); ?>", formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                }).then(function(response) {
        ...
        function DeleteDataSlider(id) {
            $('#confirmDeleteSlider').html(
                "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
            axios.post("<?php echo e(route('admin.sliderdelete')); ?>", {
                    id: id
                })
                .then(function(response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/admin/components/Slider.blade.php ENDPATH**/ ?>