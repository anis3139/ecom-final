        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <h1 class="mt-5"> You Search for: <span class="text-danger"><?php echo e($key); ?></span> </h1>
    ...
    <?php else: ?>
        ...
        <section id="content">
            <div class="content-wrap">
                <h1 class="pb-3 text-center"> You Search for: <span class="text-danger"><?php echo e($key); ?></span> </h1>
                <div class="container clearfix">
                                    ...
                                    <div class="product col-md-4 col-sm-6 col-12">
                                        <div class="grid-inner">
                                            <div class="product-image">
                                                <?php $i= 2; ?>
                                                <?php $__currentLoopData = $searchProduct->img; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($i > 0): ?>
                                                        <a
                                                            href="<?php echo e(route('client.showProductDetails', ['slug' => $searchProduct->product_slug])); ?>"><img
                                                ...
                                                <?php if($searchProduct->product_in_stock): ?>
                                                        ...
                                                        <?php if(auth()->guard()->guest()): ?>
                                                            <a href="javascript:void(0);" onclick="toastr.info('To add Favorite List. You need to login first.','Info',{
                                                                   ...
                                                                   progressBar: true,
                                                                    ...
                                                                    (<?php echo e($searchProduct->favorite_to_users->count()); ?>)</span></a>
                                                        <?php else: ?>
                                                            <a href="javascript:void(0);"
                                                                onclick="document.getElementById('favorite-form-<?php echo e($searchProduct->id); ?>').submit();"
                                                                class="<?php echo e(!Auth::user()->favorite_product->where('pivot.product_id', $searchProduct->id)->count() == 0
    ? 'favorite_posts'
    : ''); ?>"><i
                                                                    class="icon-heart3"></i><span class="text-dark">(<span
                                                                        class="favorite_posts"><?php echo e($searchProduct->favorite_to_users->count()); ?></span>)</span></a>

                                                            <form id="favorite-form-<?php echo e($searchProduct->id); ?>" method="POST"
                                                                action="<?php echo e(route('client.favorite', $searchProduct->id)); ?>"
                                                                style="display: none;">
                                                                <?php echo csrf_field(); ?>
                                                            </form>
                                                        <?php endif; ?>
                                                        <a href="" class="btn btn-dark" data-toggle="modal"
                                                            ...
                                                            onclick="productDetailsModal(<?php echo e($searchProduct->id); ?>)"><i
                                            ...
                                            <div class="product-desc">
                                                <div class="product-title">
                                                    <h3><a
                                                            href="<?php echo e(route('client.showProductDetails', ['slug' => $searchProduct->product_slug])); ?>"><?php echo e($searchProduct->product_title); ?></a>
                                                    </h3>
                                                </div>
                                                <div class="product-price">
                                                    <?php if($searchProduct->product_price != $searchProduct->product_selling_price): ?>
                                                        <del>&#2547;
                                                            <?php echo e($searchProduct->product_selling_price); ?></del>
                                                    <?php endif; ?><ins>&#2547;
                                                        <?php echo e($searchProduct->product_price); ?></ins>
                                                </div>
                            ...
                            <div class="d-block m-5">
                                ...
                                <?php echo e($searchProducts->links('vendor.pagination.simple-bootstrap-4')); ?>
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/client/pages/Search.blade.php ENDPATH**/ ?>