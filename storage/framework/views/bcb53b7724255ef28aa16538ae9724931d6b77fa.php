                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body  text-center">
                            <div id="BlogEditForm" class="container d-none">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <img src="<?php echo e(asset('default-image.png')); ?>" id="blogImageUpdatePreview" alt=""
                                            width="100%">
                            ...
                            <img id="blogLoader" class="loding-icon m-5 d-none" src="<?php echo e(asset('loader.svg')); ?>" alt="">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function getBlogData() {
            ...
            axios.get("<?php echo e(route('admin.blogData')); ?>")
        ...
        function DeleteDataBlog(id) {
            ...
            axios.post("<?php echo e(route('admin.blog.delete')); ?>", {
                    id: id
                })
                .then(function(response) {
        ...
        function BlogUpdateDetails(id) {
            ...
            axios.post("<?php echo e(route('admin.blog.edit')); ?>", {
                    id: id
                })
                .then(function(response) {
                    if (response.status == 200) {
        ...
        function BlogUpdate(id, post, title, status, blogImageUpdate) {
            ...
            if (post.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.blog.update')); ?>", formData, {
                    headers: {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/admin/components/Blog.blade.php ENDPATH**/ ?>