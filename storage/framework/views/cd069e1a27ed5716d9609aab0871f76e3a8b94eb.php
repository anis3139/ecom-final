            ...
            <div class="row">
              <div class="col-md-8 offset-md-2">
                ...
                <div class="aa-myaccount-register">
                  <form id="login-form" name="login-form" class="row" action="<?php echo e(route('client.addUser')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="col-12">
                        <h3>Registration</h3>
                    </div>
                    ...
                    <div class="col-12 form-group">
                        ...
                        <div class="float-right">
                           <span>Have Account?</span> <a href="<?php echo e(route('client.login')); ?>" class="d-block text-primary p-1"> Login </a>
                        </div>
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/client/pages/Registration.blade.php ENDPATH**/ ?>