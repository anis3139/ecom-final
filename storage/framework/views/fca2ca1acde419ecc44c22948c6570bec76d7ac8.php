...
<?php $__env->startSection('bkash_number', 'Order Settings'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('admin.components.Cupon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function addBkashNumber(bkash_number) {
            if (bkash_number.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.addBkashNumber')); ?>", {
        ...
        function addRocketNumber(rocket_number) {
            if (rocket_number.length == 0) {
                ...
                $('#submitRocketNumber').html(
                    "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
                axios.post("<?php echo e(route('admin.addRocketNumber')); ?>", {
        ...
        function addNagadNumber(nagad_number) {
            if (nagad_number.length == 0) {
                ...
                $('#submitNagadNumber').html(
                    "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
                axios.post("<?php echo e(route('admin.addNagadNumber')); ?>", {
        ...
        function addDeliveryInCity(delivary_in_city) {
            if (delivary_in_city.length == 0) {
                ...
                $('#submitDeliveryInCity').html(
                    "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
                axios.post("<?php echo e(route('admin.addDelivaryInCity')); ?>", {
        ...
        function addDeliveryOutCity(delivary_out_city) {
            if (delivary_out_city.length == 0) {
                ...
                $('#submitDeliveryOutCity').html(
                    "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
                axios.post("<?php echo e(route('admin.addDelivaryOutCity')); ?>", {
        ...
        function getCuponData() {
            ...
            axios.get("<?php echo e(route('admin.getCuponData')); ?>")
                .then(function(response) {
                    console.log(response.data);
        ...
        function CuponAdd(cupon_code, discount, type, status, exp_date) {
            ...
            if (cupon_code.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.CuponAdd')); ?>", {
        ...
        function DeleteDataCupon(id) {
            ...
            axios.post("<?php echo e(route('admin.CuponDelete')); ?>", {
                    id: id
                })
                .then(function(response) {
        ...
        function CuponUpdateDetails(id) {
            ...
            axios.post("<?php echo e(route('admin.CuponEdit')); ?>", {
                    id: id
                })
                .then(function(response) {
                    if (response.status == 200) {
        ...
        function CuponUpdate(idUpdate, cupon_codeIdUpdate, CuponDesIdUpdate, typeCupon, statusCupon, exp_dateCupon) {
            ...
            if (cupon_codeIdUpdate.length == 0) {
                ...
                axios.post("<?php echo e(route('admin.CuponUpdate')); ?>", updateData).then(function(response) {
...
<?php echo $__env->make('admin.Layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/admin/order/OrderSettings.blade.php ENDPATH**/ ?>