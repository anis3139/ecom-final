        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5">
                        <div class="row">
                            <div class="col-md-8 offset-md-2"> <?php echo $__env->make('client.component.Message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <a href="<?php echo e(route('client.SSOLogin', 'github')); ?>" class=" mt-2 button button-large btn-block si-colored si-github nott font-weight-normal ls0 center m-0"><i class="icon-github"></i> Log in with Github</a>
                
                                    </div>
                                </div>
                                <div class="aa-myaccount-register">
                                    <form id="login-form" name="login-form" class="row" action="<?php echo e(route('client.onlogin')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <div class="float-right">
                                                ...
                                                <a href="<?php echo e(route('client.registration')); ?>" class="d-block text-light p-1 button button-large si-colored si-github nott font-weight-normal ls0 center ">Register now! </a>
                                                <a href="<?php echo e(route('client.forgot')); ?>" class="d-block text-primary p-1">Forgot Password?</a>
                                            </div>
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-final\resources\views/client/pages/Login.blade.php ENDPATH**/ ?>